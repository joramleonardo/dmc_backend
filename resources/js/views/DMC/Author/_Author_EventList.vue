                                            ...
                                            <div class="row row-cards">
                                                ...
                                                <div class="col-md-12" style="color: black !important">
                                                    <div style="color: black !important">
                                                        ...
                                                        <b-form-tags style="background-color: #151F2C !important" 
                                                            required input-id="tags-basic" name="tags" v-model="album_tags" 
                                                            placeholder="Add new tags separated by enter key...">
                                                    </b-form-tags>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-9">
                                                                ...
                                                                <b-tab v-for="(photoEntry, i) in photo_tabs" :key="'dyn-tab-' + i" :title="'Photo ' + (i+1)">
                                                                    <!-- <div class="row">
                                                                        <div class="col-md-12 col-lg-12 mb-0">
                                                                            <b-form inline>
                                                                                <b-form-group v-if="photoEntry.id > 0" class="group" id="form_externalEventDate">
                                                                                    <label for="entryDate" class="label" style="color:black; font-weight: bold">Photo File Name:</label>
                                                                                    <b-form-input v-model="photoEntry.photo_fileName" placeholder="Enter Title..."   ></b-form-input>
                                                                                    <b-button @click="deletePhoto(photoEntry.id, i)"> Delete</b-button>
                                                                                </b-form-group> 
                                            ...
                                            <!-- <div class="row row-cards">
                                                <div class="col-sm-6 col-lg-6">
                                                    ...
                                                    <a href="#" class="d-block"><img src="tabler/static/photos/beautiful-blonde-woman-relaxing-with-a-can-of-coke-on-a-tree-stump-by-the-beach.jpg" class="card-img-top"></a>
                                                    <div class="card-body">
